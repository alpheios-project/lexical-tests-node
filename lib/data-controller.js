...
class DataController {
  constructor (sourceData, configData, params) {
    ...
    this.skipShortDefs = params.skipShortDefs
    this.skipFullDefs = params.skipFullDefs

    this.downloadMorphFlag = params.downloadMorph
    this.downloadShortDefFlag = params.downloadShortDef
    this.downloadFullDefFlag = params.downloadFullDef

    this.downloadFailedShortDefFlag = params.downloadFailedShortDef
    this.downloadFailedFullDefFlag = params.downloadFailedFullDef
